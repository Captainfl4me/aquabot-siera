...
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/MATLAB0_sf.mexa64
MAKEFILE                = MATLAB0.mk
...
MODELLIB                  = MATLAB0_sf.mexa64
MODELREF_LINK_LIBS        = ../../MATLAB0_sfcn_rtw/MATLAB0_sf.a
...
MODELREF_LINK_LIBS_GROUP = ../../MATLAB0_sfcn_rtw/MATLAB0_sf.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../MATLAB0_sfcn_rtw/MATLAB0_sf.a -Wl,--end-group
endif
...
MATLAB0_sf.o : $(START_DIR)/MATLAB0_sfcn_rtw/MATLAB0_sf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/MATLAB0_sfcn_rtw/MATLAB0_sf.c

rtGetInf.o : $(START_DIR)/MATLAB0_sfcn_rtw/rtGetInf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/MATLAB0_sfcn_rtw/rtGetInf.c

rtGetNaN.o : $(START_DIR)/MATLAB0_sfcn_rtw/rtGetNaN.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/MATLAB0_sfcn_rtw/rtGetNaN.c
