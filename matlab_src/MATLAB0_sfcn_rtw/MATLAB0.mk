...
MODEL                   = MATLAB0
MODULES                 = priorityqueue_api.cpp autonomouscodegen_reeds_shepp.cpp
PRODUCT                 = MATLAB0_sf.a
MAKEFILE                = MATLAB0.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2023b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2023b
START_DIR               = /home/nicolas/Bureau/aquabot-siera/matlab_src
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = GLNXA64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(MATLAB_ROOT)/extern/include/nav \
	-I$(MATLAB_ROOT)/extern/include/shared_autonomous \
	-I$(START_DIR)/MATLAB0_sfcn_rtw \
...
%.o : $(MATLAB_ROOT)/toolbox/nav/navalgs2/builtins/libsrc/priorityqueuecodegen/%.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"

%.o : $(MATLAB_ROOT)/toolbox/shared/autonomous/builtins/libsrc/autonomouscodegen/reeds_shepp/%.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
%.o : $(MATLAB_ROOT)/toolbox/nav/navalgs2/builtins/libsrc/priorityqueuecodegen/%.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) "$<"

%.o : $(MATLAB_ROOT)/toolbox/shared/autonomous/builtins/libsrc/autonomouscodegen/reeds_shepp/%.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
priorityqueue_api.o : $(MATLAB_ROOT)/toolbox/nav/navalgs2/builtins/libsrc/priorityqueuecodegen/priorityqueue_api.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/toolbox/nav/navalgs2/builtins/libsrc/priorityqueuecodegen/priorityqueue_api.cpp

autonomouscodegen_reeds_shepp.o : $(MATLAB_ROOT)/toolbox/shared/autonomous/builtins/libsrc/autonomouscodegen/reeds_shepp/autonomouscodegen_reeds_shepp.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/toolbox/shared/autonomous/builtins/libsrc/autonomouscodegen/reeds_shepp/autonomouscodegen_reeds_shepp.cpp
